...
namespace WinProgramCreatorChange
{
    ...
    public class LogService
    {
        ...
        public static void WriteSuccessData(string content)
        {
            string fileName = "LogSuccessData[" + DateTime.Now.ToString("yyyy-MM-dd") + "].log"; 
            WriteFile(fileName, "", content);
        }
        public static void WriteFailData(string content)
        {
            string fileName = "LogFailData[" + DateTime.Now.ToString("yyyy-MM-dd") + "].log";
